    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-ink-50 py-16 sm:py-20 lg:py-24">
        ...
        <div className="relative mt-10 overflow-hidden">
          <div className="pointer-events-none absolute inset-y-0 left-0 z-20 w-20 bg-gradient-to-r from-ink-50 via-ink-50/90 to-transparent sm:w-32" />
          <div className="pointer-events-none absolute inset-y-0 right-0 z-20 w-20 bg-gradient-to-l from-ink-50 via-ink-50/90 to-transparent sm:w-32" />
          <div className="pointer-events-none absolute left-3 top-1/2 z-30 -translate-y-1/2 text-ink-950/12 sm:left-5">
            <ChevronLeft size={42} strokeWidth={1.5} />
          </div>
          <div className="pointer-events-none absolute right-3 top-1/2 z-30 -translate-y-1/2 text-ink-950/12 sm:right-5">
            <ChevronRight size={42} strokeWidth={1.5} />
          </div>

          <div className="flex w-max animate-marquee items-stretch gap-6 px-4 pb-2">
            {loopedServices.map((s, i) => (
              <motion.article
                ...
                className="perspective-1000 h-full w-[82vw] shrink-0 sm:w-[420px] lg:w-[460px]"
              >
